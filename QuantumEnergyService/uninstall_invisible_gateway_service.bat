@echo off
cls
title Uninstall Invisible BIOS Gateway Service

echo ========================================================
echo    UNINSTALL INVISIBLE BIOS GATEWAY SERVICE
echo    Automatic Background Gateway Removal
echo ========================================================
echo.
...
echo [STOP] Stopping Invisible BIOS Gateway Service...
timeout /t 1 /nobreak >nul

REM Stop the service if it's running
net stop InvisibleBiosGatewayService >nul 2>&1
if %errorLevel% EQU 0 (
...
echo.
echo [UNINSTALL] Removing Invisible BIOS Gateway Service...
timeout /t 1 /nobreak >nul
...
echo.
echo [UNINSTALL] Invisible BIOS Gateway Service uninstallation complete!
echo.
