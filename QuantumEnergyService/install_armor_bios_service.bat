@echo off
cls
title Install Armor BIOS Optimization Service

echo ========================================================
echo    INSTALL ARMOR BIOS OPTIMIZATION SERVICE
...
echo.
echo [INSTALL] Installing Armor BIOS Optimization Service...
timeout /t 1 /nobreak >nul
...
echo.
echo [START] Starting Armor BIOS Optimization Service...
timeout /t 1 /nobreak >nul
...
echo.
echo [INSTALL] Armor BIOS Optimization Service installation complete!
echo.
echo Service Details:
echo   Name: ArmorBiosOptimizationService
echo   Display Name: Armor BIOS Optimization Service
echo.
echo To check service status:
echo   Open Services.msc
echo   Or run: sc query ArmorBiosOptimizationService
echo.
pause