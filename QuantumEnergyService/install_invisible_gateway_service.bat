@echo off
cls
title Install Invisible BIOS Gateway Service

echo ========================================================
echo    INSTALL INVISIBLE BIOS GATEWAY SERVICE
echo    Automatic Background Gateway Installation
echo ========================================================
echo.
...
echo.
echo [INSTALL] Installing Invisible BIOS Gateway Service...
timeout /t 1 /nobreak >nul
...
echo.
echo [START] Starting Invisible BIOS Gateway Service...
timeout /t 1 /nobreak >nul
...
echo.
echo [INSTALL] Invisible BIOS Gateway Service installation complete!
echo.
echo Service Details:
echo   Name: InvisibleBiosGatewayService
echo   Display Name: Invisible BIOS Gateway Service
echo.
echo To check service status:
echo   Open Services.msc
echo   Or run: sc query InvisibleBiosGatewayService
echo.
pause