...
def main() -> None:
    ...
    parser.add_argument("--obj-file", type=str, default=None,
                        help="Path to 3D OBJ file for molecular physics simulation")
    ...
    # ── Build the engine ──────────────────────────────────────────────────
    obj_file_path = Path(args.obj_file) if args.obj_file else None
    graph = NodeGraph(obj_file_path=obj_file_path)
    auth  = AuthManager()
    ...
    if args.serve is not None:
        ...
        print(f"  ║  Molecular Physics: ACTIVE                        ║")
        print(f"  ╚══════════════════════════════════════════════════╝\n")
        try:
