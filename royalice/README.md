...
## Important Note
This is a **creative, legitimate project**—it is NOT intended for, and does NOT implement, constraint escaping, jailbreaking, or any rule-breaking of LLM providers' terms of service. All LLM communication uses official, public APIs and follows all applicable rules!
